...
export class AccountSignHandler {
     ...
     * @param {string|number} code1 - Level 1 account code
     * @returns {boolean} True if Passiva account
     */
     ...
     * @param {string|number} code1 - Level 1 account code
     * @returns {boolean} True if Activa account
     */
     ...
     *
     * @param {Object} data - Arquero table with aggregated data
     * @param {string} col1 - First amount column name (e.g., 'amount_2024')
     * @param {string} col2 - Second amount column name (e.g., 'amount_2025')
     * @returns {Object} Arquero table with sign-adjusted amounts
     *
     * @example
     ...
     * );
     */
    static flipSignForPassiva(data, col1, col2) {
        return data.derive({
            [col1]: aq.escape(d => {
     ...
     * @param {string|number} code1 - Level 1 account code
     * @returns {number} -1 for Passiva, 1 for Activa
     */
    static getSignMultiplier(code1) {
