...
export class BalanceSheetSpecialRows {
     ...
     * @param statementData - Full statement data with totals
    ...
    insert(data: any[], statementData: StatementData): any[] {
        ...
        const totalLEWithIncome: YearTotals = {
     ...
     * @param data - Statement data rows
     * @returns Total assets for both years
     */
    calculateTotalAssets(data: any[]): YearTotals {
        let year1 = 0, year2 = 0;
     ...
     * @param data - Statement data rows
     * @returns Total L&E for both years
     */
    calculateTotalLiabilitiesEquity(data: any[]): YearTotals {
        let year1 = 0, year2 = 0;
     ...
     * @param data - Statement data
     * @returns Index where to insert, or -1 if not found
     */
    findEquityInsertIndex(data: any[]): number {
        ...
        for (let i = 0; i < data.length; i++) {
            const code1 = parseInt(String(data[i].code1));
     ...
     * @param totalAssets - Total assets {year1, year2}
     * @param totalLE - Total liabilities & equity {year1, year2}
     * @param year1 - First year
     * @param year2 - Second year
     */
    validateBalanceSheet(totalAssets: YearTotals, totalLE: YearTotals, year1: string, year2: string): void {
