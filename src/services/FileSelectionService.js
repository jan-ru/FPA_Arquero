...
export class FileSelectionService {
     ...
     * @param {DataLoader} dataLoader - DataLoader instance for directory operations
     */
     ...
     * @returns {Promise<{dirHandle: FileSystemDirectoryHandle, dirName: string, pathDisplay: string}>}
     ...
     * @returns {Promise<string>} Formatted path or directory name
     * @private
     */
     ...
     * @returns {Promise<{exists: boolean, missingFiles: string[]}>}
     */
     ...
     * @returns {Promise<{success: boolean, dirHandle?: FileSystemDirectoryHandle, dirName?: string, pathDisplay?: string, error?: string}>}
     */
